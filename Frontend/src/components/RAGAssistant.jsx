...
function NotebookCard({ notebook, onOpen, onDelete, onRename, theme: t }) {
  ...
  const totalChunks = (notebook.papers || []).reduce(
    (s, p) => s + (p.chunks || 0),
    0,
  );
    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{
            background: menuOpen ? t.surface2 : "none",
            border: "none",
            cursor: "pointer",
            color: t.textDim,
            display: "flex",
        ...
        <div onClick={(e) => e.stopPropagation()} style={{ marginBottom: 6 }}>
          ...
          {saving && (
            <Loader2
              size={10}
              color={t.textDim}
              style={{ animation: "spin .7s linear infinite", marginTop: 3 }}
            />
          )}
        </div>
      ) : (
      ...
      >
        ...
        >
          <FileText size={11} />
          {(notebook.papers || []).length} source
          {(notebook.papers || []).length !== 1 ? "s" : ""}
        </span>
        <span
          style={{
            display: "flex",
...
export function RAGAssistant({
  ...
  const handleCreate = useCallback(async () => {
    ...
    try {
      ...
      setNotebooks((prev) => [
        { ...nb, papers: [], fileCount: 0, msgCount: 0 },
        ...prev,
      ]);
      setNewName("");
      setCreating(false);
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "32px 28px" }}>
        ...
        {loadingList ? (
          ...
          <div style={{ textAlign: "center", marginTop: 80 }}>
            ...
            />
            <p style={{ fontSize: 14, color: t.errColor, marginBottom: 12 }}>
              {listError}
            </p>
            <button
          ...
          >
            ...
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = "#b1b1b1";
            ...
            >
              ...
              <p style={{ fontSize: 13, color: t.textDim, fontWeight: 500 }}>
                New notebook
              </p>
            </div>
          </div>
