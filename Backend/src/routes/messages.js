...
router.post("/", asyncHandler(async (req, res) => {
  ...
  const message = await db.chatMessage.create({
    data: { notebookId, role, content: content.trim(), sources },
  });
...
router.delete("/", asyncHandler(async (req, res) => {
  ...
  const { count } = await db.chatMessage.deleteMany({ where: { notebookId } });
...
router.delete("/:msgId", asyncHandler(async (req, res) => {
